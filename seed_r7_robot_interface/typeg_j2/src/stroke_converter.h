#ifndef _TYPE_G_J2_STROKE_CONVERTER_H_
#define _TYPE_G_J2_STROKE_CONVERTER_H_
...
class TypeG_J2 : public StrokeConverter
{
public:
  void makeTables();
...
private:
  ...
  const std::string lifter_csv_dir = "/typeG_J2_lifter";
};
